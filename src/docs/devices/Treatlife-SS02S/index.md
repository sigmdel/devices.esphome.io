...
* **Note:** These devices are sold with different Beken chips. Inspect your board before flashing!
  ...
  * Newer versions feature the BK7238 board (`CB3S-V200` label on the RF shied) 
  * Some I/O pins are different for the three boards (see the configuration below)
...
![BK7238](BK7238.jpg "BK7238, aka CBS-V200 board")
